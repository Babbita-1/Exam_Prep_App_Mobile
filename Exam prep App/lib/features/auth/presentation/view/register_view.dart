...
class _RegisterViewState extends State<RegisterView> {
  ...
  final _nameController = TextEditingController(text: 'Babita bista');
  final _usernameController = TextEditingController(text: 'bista');
  ...
  final _confirmPasswordController = TextEditingController(text: '123456790');
